...
const ProcessOrder = () => {
  ...
  // 2. Initialize Update Mutation with Loading State
  const [updateOrder, { error, isSuccess, isLoading: isUpdating }] = useUpdateOrderMutation();
              ...
              <div className="row my-5">
                <div className="col-4 col-lg-2">
                  <img
                    ...
                    height="45"
                    width="65"
                    // Image Fallback for broken demo links
                    onError={(e) => {
