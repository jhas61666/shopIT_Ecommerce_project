...
const UpdatePassword = () => {
    ...
    useEffect(() => {
        ...
        // Removed 'user' from dependencies to fix ReferenceError
    ...
    const submitHandler = (e) => {
        ...
        // Use the mutation function 'updatePassword', not the component name
                    ...
                    <form className="shadow rounded bg-body" onSubmit={submitHandler} >
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                className="form-control"
                                value={password}
                                // Fixed: setPassword instead of setOldPassword
